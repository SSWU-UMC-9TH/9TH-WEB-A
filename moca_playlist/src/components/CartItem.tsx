  ...
  return (
    <div className="flex items-center p-4 border-b border-gray-200">
      ...
      <div className="flex items-center">
        <button onClick={handleDecreaseCount} className="px-3 py-1 bg-[#CED4DA] rounded-l hover:bg-[#E9ECEF] cursor-pointer">
          -
        </button>
        <span className="px-4 py-[3px] border-y border-gray-300">
          {lp.amount}
        </span>
        <button onClick={handleIncreaseCount} className="px-3 py-1 bg-[#CED4DA] rounded-r hover:bg-[#E9ECEF] cursor-pointer">
          +
        </button>
      </div>
    </div>
